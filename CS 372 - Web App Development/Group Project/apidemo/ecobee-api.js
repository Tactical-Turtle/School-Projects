 ...
 * temperature params.
 */
 ecobee.SetHoldFanFunction = function(cool_hold_temp, heat_hold_temp, hold_type) {
	this.type = 'setHoldFan';
 ...
 */
 ecobee.SetModeFunction = function(selectedMode) {
	this.type = 'setMode';

	this.params = {
		hvacMode : selectedMode,
	}
}
/**
...
exports.SetHoldFanFunction = ecobee.SetHoldFanFunction;
exports.SetModeFunction = ecobee.SetModeFunction;
